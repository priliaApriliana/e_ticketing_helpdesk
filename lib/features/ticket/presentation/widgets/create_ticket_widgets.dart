...
class CreateTicketBackdrop extends StatelessWidget {
  const CreateTicketBackdrop({super.key});
...
class CreateTicketTopBar extends StatelessWidget {
  const CreateTicketTopBar({super.key});
...
class CreateTicketHeroPanel extends StatelessWidget {
  const CreateTicketHeroPanel({super.key});
...
class CreateTicketFormPanel extends StatelessWidget {
  final TicketProvider controller;

  const CreateTicketFormPanel({super.key, required this.controller});
...
class CreateTicketSectionTitle extends StatelessWidget {
  final String title;
  final String subtitle;

  const CreateTicketSectionTitle({super.key, required this.title, required this.subtitle});
...
class CreateTicketActionChip extends StatelessWidget {
  final IconData icon;
  final String label;
  final VoidCallback onTap;

  const CreateTicketActionChip({
    super.key,
    required this.icon,
    required this.label,
    required this.onTap,
