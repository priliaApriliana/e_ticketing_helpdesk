...
import 'package:e_ticketing_helpdesk/features/auth/presentation/pages/forgot_password_page.dart';
...
import 'package:e_ticketing_helpdesk/features/ticket/presentation/pages/tracking_ticket_page.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(name: Routes.ticketTracking, page: () => const TrackingTicketScreen()),
